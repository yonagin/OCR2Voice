    ...
    async def voice(
        ...
        with BytesIO() as Content:
            if format == 'wav':
                ...
                sf.write(Content, audio, sr, format='MP3')
                media_type = 'audio/mpeg'
            logger.info(f"Audio data {format} generated and sent successfully")
            return Response(content=Content.getvalue(), media_type=media_type)
